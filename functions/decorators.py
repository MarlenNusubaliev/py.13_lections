# decorators - это функция которая позволяет без измение кода функции расширить ее функционал
...
'''Напишите декоратор, который проверяет, что функция вызывается с определенными типами аргументов.'''
